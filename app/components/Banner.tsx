...
const Banner = () => {
  return (
    <section className="flex items-center justify-center flex-col">
      ...
      <div className="bg-[url('./assets/images/h1-slider01.jpg')] w-full py-8 bg-no-repeat bg-cover">
        <div className="flex justify-center md:flex-row flex-col items-center md:space-x-40 space-y-8 px-4 md:px-0">
          <div className="banner_slider__image">
            <Image
              className="w-[250px] h-[250px] md:w-[600px] md:h-[500px] object-contain"
              width={600}
              height={600}
              src={bannerFirst}
              alt="banner-image"
          ...
          <div className="flex justify-center md:items-center items-start flex-col space-y-3">
            <h2 className="md:text-6xl text-3xl text-white font-bold drop-shadow-[0_5px_10px_rgba(0,0,0,0.75)] text-center md:text-left">
              Order Online or Visit <br /> Rukn Al Safa Pharmacy
            </h2>

            <div className="flex justify-between items-center md:space-x-24 space-x-8">
              <p className="text-white font-bold">Code: SAVE18</p>

              <div className="flex items-center space-x-2">
                <a
                  href="#"
                  className="p-3 group rounded-full bg-white hover:bg-cyan-500"
                >
